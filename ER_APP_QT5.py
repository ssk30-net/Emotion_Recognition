...
def plot_emotion_pie_chart_speech(emotion_probs, emotions, predicted_emotion):
...
class MainWindow(QMainWindow):
    ...
    def analyze_text_emotion(self, text):
        ...
        # Define keywords associated with each emotion
        ...
        predicted_emotion = 'neutral'  # Default to neutral if no keywords match
        ...
        for emotion, keywords in keyword_emotion_mapping.items():
            for keyword in keywords:
                if keyword in text_lower:
                    ...
                    break
            if predicted_emotion != 'neutral':  # Break outer loop if emotion is predicted
                break

        # Generate psychologist-like feedback
        results_text = provide_psychologist_feedback(emotions.index(predicted_emotion))

        # Plot emotion probabilities in a pie chart
        buf = plot_emotion_pie_chart_text(emotions.index(predicted_emotion))
    ...
    def record_and_analyze_speech(self):
        ...
        buf = plot_emotion_pie_chart_speech(prediction_probs, emotions, predicted_emotion)
